...
const translations: Translations = {
  pt: {
    ...
    artworkModal: {
      ...
      originalSizeLabel: 'Obra original',
      originalSizeNote: 'Medida da obra original, única e assinada pelo artista.',
      dimensions: 'Dimensões disponíveis',
      dimensionsNote: 'As demais dimensões são cópias assinadas da obra original.',
      usdRateNote: 'Valores em dólar convertidos automaticamente pela cotação atual: US$ 1 = {rate}.',
      usdRateFallback: 'Cotação de referência — não foi possível atualizar agora.',
      technique: 'Técnica',
      values: 'Valores',
      original: 'Original',
      copy: 'Cópia Assinada',
    ...
    contact: {
      ...
      whatsappNote: 'Resposta mais rápida',
      emailLabel: 'Email',
      ...
      form: {
        ...
        error: 'Ocorreu uma falha no envio da sua mensagem. Tente novamente em instantes ou fale comigo pelos canais diretos.',
        privacyNote: 'Sua mensagem chega direto ao ateliê. Não compartilhamos seus dados.',
      },
  ...
  en: {
    ...
    artworkModal: {
      closeAria: 'Close',
      originalBadge: 'Original',
      originalSizeLabel: 'Original artwork',
      originalSizeNote: 'Size of the original artwork, unique and signed by the artist.',
      dimensions: 'Available dimensions',
      dimensionsNote: 'The other dimensions are signed prints of the original artwork.',
      usdRateNote: 'Dollar amounts converted automatically at the current rate: US$ 1 = {rate}.',
      usdRateFallback: 'Reference rate — could not be updated right now.',
      technique: 'Technique',
      values: 'Pricing',
      original: 'Original',
      copy: 'Signed Print',
    ...
    contact: {
      ...
      form: {
        ...
        error: 'Something went wrong while sending your message. Please try again in a moment, or reach me through the direct channels.',
        privacyNote: 'Your message goes straight to the studio. We never share your data.',
      },
